...
#include "../../../pico-sdk/src/rp2040/hardware_structs/include/hardware/structs/spi.h"
...
// added by @paulsk
//#include "../../../pico-sdk/src/rp2040/hardware_structs/include/hardware/structs/i2c.h"
//#include "../../../pico-sdk/src/rp2040/hardware_regs/include/hardware/regs/i2c.h"

#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <stdint.h>  // added by @paulsk for uint32_t
...
namespace pimoroni 
{
  ...
  class RV3028
  {
    ...
    public:
      ...
      uint8_t init();  // was void init(); I @paulsk changed this to give back the result of a call to: readRegister(RV3028_ID)
                        // example return value: 399361.
      ...
      uint8_t getTime();  // Added by @paulsk, to get the _time array contents
      uint8_t daysInMonth(uint8_t year, uint8_t month);   // Added by @paulsk, from micropython/timeutils
      bool isLeapYear(uint16_t year);    // added by @paulsk, idem
      uint8_t yearday(uint16_t year, uint8_t month, uint8_t date); // idem
      ...
      char* stringDate(); 
      char* stringDT();  //Max of yyyy-mm-dd hh:mm:ss plus a \0 terminator
      ...
      uint8_t getMonth();
      uint8_t getYear();
      uint8_t get_Time(uint8_t);  // Returns the _time array
